function [ UT, Output_final,Subclock ] = function_makeCycleClockMultiROI(varargin)
% Trigger signals to sychronize hardware during multi-region correction
